...
type GoodsClient interface {
	...
	GetHistory(ctx context.Context, in *GetHistoryRequest, opts ...grpc.CallOption) (*GetResponse, error)
...
func (c *goodsClient) GetHistory(ctx context.Context, in *GetHistoryRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetResponse)
...
type GoodsServer interface {
	...
	GetHistory(context.Context, *GetHistoryRequest) (*GetResponse, error)
...
func (UnimplementedGoodsServer) GetHistory(context.Context, *GetHistoryRequest) (*GetResponse, error) {
...
func _Goods_GetHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).GetHistory(ctx, req.(*GetHistoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
